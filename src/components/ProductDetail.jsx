    ...
    <div className="flex flex-col w-full max-w-xl bg-white text-black font-sans p-6 md:p-0">
      ...
      <div className="flex flex-col gap-4 mb-12">
        <div className="flex gap-4">
          ...
          <button className="flex-1 bg-black text-white h-14 uppercase font-black tracking-[0.15em] hover:bg-zinc-800 transition-all active:scale-[0.98] flex items-center justify-center gap-3">
