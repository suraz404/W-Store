    ...
    <footer className="bg-black text-gray-200 py-10">
      ...
      <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm">
        <p>
          ...
          <span className="text-white">W-Store</span>. All rights reserved
        </p>
      </div>
    </footer>
  );
